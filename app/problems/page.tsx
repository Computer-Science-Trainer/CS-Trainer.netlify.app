  ...
  >([
    {
      ...
      description: "Изучение основ программирования, включая переменные, циклы и функции.",
    },
    {
      label: "Алгоритмы",
      isSelected: false,
      ...
      description: "Основные алгоритмы, такие как сортировка, поиск и работа с графами.",
    },
    {
      ...
      description: "Изучение структур данных, включая массивы, списки и деревья.",
    },
    {
      label: "Базы данных",
      isSelected: false,
        ...
        <div>
          <div className="flex flex-col items-start mt-8 pl-4">
            <div className="relative flex flex-col items-start">
              <div className="absolute top-1 bottom-5 left-2 w-[2px] bg-gray-300 dark:bg-gray-600 z-0"></div>
      ...
      centralPanel={
        <div>
            ...
            <CardBody className="flex flex-col items-center justify-center gap-8">
              ...
              <CardHeader>
              <h3 className="text-xl font-bold">Генерация личного варианта</h3>
              </CardHeader>
              <CardBody>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="mt-8">
            {topics.map((topic, index) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a neque risus. Pellentesque dictum massa in tortor pellentesque, quis dapibus ante pulvinar. Donec erat leo, tempus vitae placerat ac, pulvinar non sapien. Curabitur finibus fermentum libero eget mollis. Proin velit nisi, tincidunt quis auctor in, aliquam vitae nibh. In magna enim, auctor condimentum ornare ut, hendrerit suscipit neque. Ut pulvinar cursus arcu eu suscipit. Cras nisi lectus, suscipit id turpis a, dapibus ullamcorper dui. Maecenas suscipit erat urna, et tincidunt mi vulputate id. Aliquam condimentum ante at metus ultricies, eu pharetra nisi consectetur. Suspendisse volutpat sem quis convallis auctor. Morbi malesuada consequat turpis id vestibulum. Duis libero tellus, eleifend eu felis lacinia, luctus facilisis dolor. Mauris varius tincidunt justo sed bibendum.

Nullam nec scelerisque mauris. Aenean sollicitudin blandit nisl, non ornare nunc egestas in. Aliquam gravida sodales faucibus. Nam dictum auctor nunc, ut dignissim justo sodales eu. Curabitur mattis libero et nisl gravida, fermentum mattis tellus consequat. In accumsan ullamcorper metus, in lobortis justo iaculis et. Praesent condimentum eget sem non ultricies.

Nunc suscipit sapien orci, ac semper nibh pretium vitae. Nulla non lacinia ex, sit amet rhoncus est. Sed rutrum ultrices nibh, vel vulputate magna sodales nec. Proin blandit feugiat dui placerat aliquam. Donec auctor libero nisl. Nullam rutrum rutrum ultrices. Sed fermentum leo nisl. Mauris mattis vitae sem eu convallis. Mauris vestibulum, ante in lacinia efficitur, nisl est feugiat nulla, in ultricies neque massa nec lacus. Pellentesque iaculis at magna vel faucibus.
                </p>
              </div>
            ))}
          </div>
